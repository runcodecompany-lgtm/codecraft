        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-wrap items-center gap-4 md:gap-6 text-gray-500 text-sm mb-8 border-y py-4 border-gray-100">
            ...
            <div className="flex items-center gap-2 mr-auto">
              <div className="flex items-center gap-2">
                <a 
                  href={`https://wa.me/?text=${encodeURIComponent(post.title + ' ' + (process.env.NEXT_PUBLIC_APP_URL || '') + '/news/' + post.slug)}`}
                  target="_blank"
                ...
                <a 
                  href={`https://twitter.com/intent/tweet?text=${encodeURIComponent(post.title)}&url=${encodeURIComponent((process.env.NEXT_PUBLIC_APP_URL || '') + '/news/' + post.slug)}`}
                  target="_blank"
                  rel="noopener noreferrer"
                ...
                <a 
                  href={`https://www.facebook.com/sharer/sharer.php?u=${encodeURIComponent((process.env.NEXT_PUBLIC_APP_URL || '') + '/news/' + post.slug)}`}
                  target="_blank"
                  rel="noopener noreferrer"
